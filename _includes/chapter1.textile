...
_Figure 1.7  Polarity convention; voltage $V_2$ is the difference $(V_B - V_A)$ *(WRONG FIGURE???)*._
...
h4(#chapter1-types). 1.7 - Types of Circuit Constraints
