...
table(#figure5-1).
|\2=. !{width:99%}img/5/circuitsF5.1a.jpg(Figure 5.1)!:img/1/circuitsF5.1a.jpg |=. !{width:70%}img/5/circuitsF5.1b.jpg(Figure 5.1)!:img/1/circuitsF5.1b.jpg |
|/2=. (a) Series (Single Loop) Restriction |=. (b) NOT Single-Loop |
