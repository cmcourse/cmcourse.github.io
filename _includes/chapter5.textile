...
Alternately we might want an output voltage, $V_{out}$, that is more directly related to light level, that is, we desire an output voltage that _increases_ as the light level, $S$, _increases_, a direct relationship.  To obtain this result we 'reverse' the positions of the two resistors.  Namely we place the photo-sensitive resistor, $R_{ph}$, at the 'top' position of the divider, and the fixed $R_m$ at the 'bottom' output side of the divider circuit.
