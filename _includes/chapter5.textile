...
Consider the first special topology the _single loop_ circuit structure, see "Figure 5.1":#figure5-1.  Here we mean that all elements of the circuit are connected so they form a single loop.  Because the circuit is a single loop, and because of our KCL current law, there can be only one current in all elements in the loop.  "Figure 5.1":#figure5-1 depicts this arrangement, called a series connection.

table(#figure5-1).
|\2=. !{width:99%}img/5/circuitsF5.1a.jpg(Figure 5.1)!:img/1/circuitsF5.1a.jpg |=. !{width:60%}img/5/circuitsF5.1b.jpg(Figure 5.1)!:img/1/circuitsF5.1b.jpg
