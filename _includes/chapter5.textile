...
For this relation, as the light intensity *decreases*, $S$ gets smaller and $R_{ph}$ _gets larger_.  So for indoor conditions, if $S = 0.01$ then the value of $R_{ph}$ increases to 10,000 ohms.
