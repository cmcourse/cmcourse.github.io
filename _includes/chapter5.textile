...
table(#figure5-1).
|\2=. !{width:90%}img/5/circuitsF5.1a.jpg(Figure 5.1)!:img/1/circuitsF5.1a.jpg |=. !{width:90%}img/5/circuitsF5.1b.jpg(Figure 5.1)!:img/1/circuitsF5.1b.jpg
...
p=(#figure5-2). !{width:50%}img/5/circuitsF5.2.jpg(Figure 5.2)!:img/5/circuitsF5.2.jpg
_Figure 5.2  Example Circuit, 3 Elements in Single Loop _
...
p=. divide by R1: $(v_{n1}/R_1) = (V_S/R_1)$

p=. and substitute: $v_{n2}((1/R_1) + (1/R_2)) = V_S/R_1$

p=. so finally: $v_{n2} = (R_2/(R_1 + R_2))V_S$
