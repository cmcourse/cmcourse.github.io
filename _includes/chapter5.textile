...
so finally, "Eq'n. 5.2":#eq5-2: <h4>
	
p=(#eq5-2).  $v_{n2} = \frac{R_2}{(R_1 + R_2)}$  Eq'n 5-2</h4>
...
p=(eq5-4). $frac\{R_p}{S}$  - ohms Eq'n 5.4
...
p=(#eq5-5). p=. $V_{out} = $  $(\frac{R_p}{(R_m + R_p)})  V_S$  Eq'n 5.5
...
p=. $V_{out} = $  $\frac{100/S}{(R_m + 100/S)}  V_S = frac\{100/S{S R_m}} V_S$
