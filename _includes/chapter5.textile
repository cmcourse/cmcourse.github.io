...
p=(#figure5-4). !{width:70%}img/5/circuitsF5.4.jpg(Figure 5.4)!:img/5/circuitsF5.4.jpg
...
p=(#figure5-5). !{width:70%}img/5/circuitsF5.5.jpg(Figure 5.5)!:img/5/circuitsF5.5.jpg
...
The second special circuit topology is one where all elements are connected between the _same 2 nodes_. 5.7":#figure5-7 depicts an example of a 2-node (single node-pair) circuit.

p=(#figure5-7). !{width:70%}img/5/circuitsF5.7.jpg(Figure 5.7)!:img/5/circuitsF5.7.jpg
