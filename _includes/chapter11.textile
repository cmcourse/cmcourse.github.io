...
p=(#figure11-23). !{width:50%}img/11/circuitsF11.23.jpg(Figure 11.23)!:img/11/circuitsF11.23.jpg
...
p=. $v_{Cinit}$ = 0
$v_{Cfinal} = $\frac{6||1}{6||1+3}$ $(6)$ = $frac{\frac{6}{7}}{\frac{6}{7}+3}$ $(6)$ = $\frac{6}{27}$ $(6)$ = $\frac{4}{3}$
