...
The switched $RC$ circuit response is inherently a transition from an initial state to a final state.  The rate of transition is dependent upon the effective time-constant of the capacitor and the Thevenin equivalent resistance at the capacitor terminals.
