...
We can apply our transient solution method to the switched R-C (Resistor-Capacitor) circuit problem.  Using the basic structure of Figure 11-10 with numerical values consider the circuit in Figure 11-13, we desire to determine the output voltage vout(t) for t > 0.
