...
h4(#chapter11-energy-storage). 11.2 - Special Constraint Energy Storage
...
** 11.3.1 _Capacitor-Current Waveform Example_
...
** 11.4.1 _Convenient Form for the Universal Switch Response Solution_
...
p=. $v_C(t)$ = $(v_{Cinit} - v__{Cfnl})$ $e^\frac{-t}{\tau}$ + $v_{Cfnl}$  [eq'n 4]

This general solution expresses a full range of possible solutions.  Consider the cases where the final value is smaller than the initial value, 'falling' curve 'A'; and where the final value is larger than the initial value, 'rising' curve 'B' as depicted in "Figure 11.12":#figure11-12.


p=(#figure11-12). !{width:90%}img/11/circuitsF11.12.jpg(Figure 11.12)!:img/11/circuitsF11.12.jpg
