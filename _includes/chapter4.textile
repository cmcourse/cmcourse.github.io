...
p=. At node $n_2$: $-i_1 + i_2 + i_5 = 0$       and

p=. At node $n_3$: $1 + i_3 = 0$   or   $i_3 = 1$
...
p=. At node n_2: $-(6-v_{n2})/2 + (v_{n2} - 0)/3 +1 = 0$

p=. At node n_{n3}: $1+(v_{n3} -0)/1 = 0$
...
p=. $i_1 = (v_{n1} - v__{n2})R_3 = (6-(12/5))/2k = (30-12)/10k = 9/5$ mA
