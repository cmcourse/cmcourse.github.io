...
h4(#chapter4-node-method). 4.3 - The 'Node Voltage Method' of Circuit Analysis
...
p=. $P_{R1} = (6-v_{N2})(i_1) = ((30-12)/5)$ volt (9/5) mA = 162/25  mWatt
...
h4(#chapter4-mesh-method). 4.4 - The 'Mesh Loop Method' of Circuit Analysis
...
p=(#figure4-4). !{width:50%}img/4/circuitsF4.4.jpg(Figure 4.4)!:img/4/circuitsF4.4.jpg
...
p=(#figure4-5). !{width:50%}img/4/circuitsF4.5.jpg(Figure 4.5)!:img/4/circuitsF4.5.jpg
_Figure 4.5  Single Element Voltage Solution by a KVL Loop_
