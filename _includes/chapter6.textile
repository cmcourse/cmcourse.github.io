...
** And by a similar process $V_a$  can be calcuate via another voltage divider if $V_b$ is known
# Task B:  Find the voltage $V_b$ valaue by use of several resistance reductions and a voltage divider
** First reduce the resistances to obtain a single equivalent at $V_b$.
