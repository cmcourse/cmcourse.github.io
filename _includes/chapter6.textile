...
h4(#chapter6-voltage-divider). 6.5 - Example Equivalents and Voltage-Dividers
...
**  Note it is *WRONG* to think that $V_a$ is determined as a voltage divider with just the two resistors of 3 ohm and 6 ohms !  They are NOT in series, "Figure 6.14":#figure6-14 !!
***  (The correct method will be shown below.)

*TASK B:* But as of yet, we do not have a value for $V_a$.  So lets get it.

We can reduce the circuit to the right of node $V_a$, since the 4 and 2 ohm resistors are in series and result in $R_{eq1} = 6$ ohms, so the resultant circuit becomes:

p=. !{width:50%}img/6/circuitsF6.14b.jpg(Figure 6.14b)!:img/6/circuitsF6.14b.jpg

but now notice there are two 6 ohm resistors both connected at node Va to ground, and so they are in parallel.  And that means they can be reduced to an equivalent single resistor $R_{eq2}$ = 3 ohms, via:

p=. $R_{eq2}$ = $\frac{6 6}{6+6}$ = 3 ohm

Thus now the further reduced circuit becomes:

p=(#figure6-14c). !{width:40%}img/6/circuitsF6.14c.jpg(Figure 6.14c)!:img/6/circuitsF6.14c.jpg
_Figure 6.14c  Voltage Divider, Portion of Full Mixed Circuit Problem_

Here there is again a voltage divider relation between 12 volts and $V_a$, therefore $V_a = (½) 12$.
 
p=. $V_a$ = $(\frac{3}{3+3})(12)$ = $\frac{1}{2}(12)$ = 6 volts

*TASK C:* Solving for $_{Vout}. Since "Figure 6.14":#figure6-14 is a voltage-divider circuit between $V_{out}$ and $V_a$ we can write by inspection:
