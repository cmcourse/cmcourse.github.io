...
Thus, *_from the node terminals_* of $v_{n1}$ and $v_{n2}$, and same total current, $i$, these two circuits 6.8(a) and 6.8(b) are exactly the same.  This means we can replace a 'group' of N parallel-connected resistors with a single resistor of value, $R_{equiv}$, where 1/$R_{equiv}$ is equal to the sum of inverses of those N values, Eq’n 6.2.

<h4>
p=. $\frac{1}{R_{equiv}}$ = $\sum_{j=1}^{N} \frac{1}{R_j}$</h4> ..... Eq'n 6.2
...
p=. _Figure13-A ......... Figure 13-B ......... Figure 13-C_
