...
** First reduce the resistances to obtain a single equivalent resistance at $V_a$.
# *Task C:*  Use the voltage $V_a$ to calculate by voltage divider relationthe value for $V_{out}$ 
...
**  Note it is *WRONG* to think that $V_a$ is determined as a voltage divider with just the two resistors of 3 ohm and 6 ohms !!
***  (The correct way will be shown below.)
