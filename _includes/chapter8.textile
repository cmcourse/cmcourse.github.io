...
p=(#figure8-17). !{width:35%}img/8/circuitsF8.17.jpg(Figure 8.17)!:img/8/circuitsF8.17.jpg
...
p=. $R_{AB}$ = $R_1$ || $(R_2 + R_3)$ = $R_A$ + $R_B$
$R_{AC}$ = $R_2$ || $(R_1 + R_3)$ = $R_A$ + $R_C$
$R_{BC}$ = $R_3$ || $(R_1 + R_2)$ = $R_B$ + $R_C$
...
p=. $R_1$ = $\frac{(R_AR_B) + (R_BR_C) + (R_AR_C_)}{R_C}$,
$R_2$ = $\frac{(R_AR_B) + (R_BR_C) + (R_AR_C_)}{R_B}$, and
$R_3$ = $\frac{(R_AR_B) + (R_BR_C) + (R_AR_C_)}{R_A}$
...
p=(#figure8-20). !{width:45%}img/8/circuitsF8.20.jpg(Figure 8.20)!:img/8/circuitsF8.20.jpg
...
The total $R_{eq}, under the constraint of high $R_3$ thus becomes approximately:
