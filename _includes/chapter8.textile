...
p=(#figure8-17). !{width:30%}img/8/circuitsF8.17.jpg(Figure 8.17)!:img/8/circuitsF8.17.jpg
...
p=(#figure8-18). !{width:75%}img/8/circuitsF8.18.jpg(Figure 8.18)!:img/8/circuitsF8.18.jpg
...
Solving these three equations for $R_A$, $R_B$, and $R_C$, yields, Eq'n 8-3:

p=. $R_A$ = $\frac{R_1R_2}{(R_1 + R_2 + R_3)}$, $R_B$ = $\frac{R_1R_3}{(R_1 + R_2 + R_3)}$, and $R_C$ = $\frac{R_2R_3}{(R_1 + R_2 + R_3)}$
Eq'n 8-5  Transformation from 'Delta' to 'Wye' Representations

Alternately, if starting from the 'Y' configuration, then the 'delta' can be calculated from:
...
Where, the values of $R_A$, $R_B$, and $R_C$ are those in Eq’n 8-3.  Now we have two sets of two resistors in series, so the circuit can be reduced to "Figure 8.20":#figure8-20:
...
p=. $R_{eq}$ = $R_A$ + $\frac{(R_B + R_4)(R_C + R_5)}{(R_B + R_4) + (R_C + R_5)}$
...
Thus we can simplify our equivalent resistance values as follows:
...
p=. $R_A$ = $\frac{R_1R_2}{(R_1 + R_2 + R_3)}$ = $\frac{R_1R_2}{R_3}$
...
p=(#figure8-22). !{width:45%}img/8/circuitsF8.22.jpg(Figure 8.22)!:img/8/circuitsF8.22.jpg
...
p=. $R_{eq}$ = $\frac{(R_1+R_4)(R_2+R_5)}{(R_1+R_4)+(R_2+R_5)}$  .... where .... $\frac{(R_2+R_5)}{(R_1+R_4)}$ = $\frac{R_5}{R_4}$ = $\frac{R_2}{R_1}$
...
p=(#figure8-23). !{width:45%}img/8/circuitsF8.23.jpg(Figure 8.23)!:img/8/circuitsF8.23.jpg
_Figure 8.23   Balanced Bridge Equivalent Resistance, With Bridge Resistor $R_3$_

From the prior subsection ($i$) we calculated the equivalent resistance to be approximately:
