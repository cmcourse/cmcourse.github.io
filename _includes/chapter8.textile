...
|\2=. !{width:55%}img/8/circuitsF8.8c.jpg(Figure 8.8)!:img/8/circuitsF8.8c.jpg |
...
p=(#figure8-9). !{width:65%}img/8/circuitsF8.9.jpg(Figure 8.9)!:img/8/circuitsF8.9.jpg
...
p=(#figure8-11). !{width:50%}img/8/circuitsF8.11.jpg(Figure 8.11)!:img/8/circuitsF8.11.jpg
...
p=.	$R_{eq}$ = $\frac{R_1 ± (R_1^2 + 8R_1^2)^1/2}$
...
p=(#figure8-12). !{width:50%}img/8/circuitsF8.12.jpg(Figure 8.12)!:img/8/circuitsF8.12.jpg
_Figure 8.12   Symmetric Single Mesh Resistor_

This circuit can be reduced by the method of equivalents.  Firstly, there are two pairs of two 3k resistors each in series.  Hence the circuit reduces to two 6 k resistors in parallel.  And these reduce to 1 single equivalent resistor between terminals A-A' of $3 k$.  This reduction is depicted in "Figure 8.13":#figure8-13.
