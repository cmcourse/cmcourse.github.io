...
To reduce this group of inductors, first (A) recognize that the three 2µH inductors are connected in parallel, so they can be replaced by a single equivalent 2/3 $\mu$H inductor, "Figure 13.6a":#figure13-6a.
...
p=. $L_{eq}$ = $\frac{(3x10^{-6})(1)}{3x10^{-6}+1}$ = $\frac{3x10^{-6}}{1.000003}$ = 3 $\mu H$
