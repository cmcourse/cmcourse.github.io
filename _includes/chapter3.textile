...
p=(#figure3-4). !{width:50%}img/3/circuitsF3.4.jpg(Figure 3.4)!:img/3/circuitsF3.4.jpg
...
h4(#chapter3-KVL). 3.2 - Power Constraint, an Overall Circuit Constraint
...
p=(#figure3-5). !{width:50%}img/3/circuitsF3.5.jpg(Figure 3.5)!:img/3/circuitsF3.5.jpg
...
p=. $P_total = v_Ai_A +v_Bi_B + v_Ci_C = e_2 i_A - e_1 i_A + e_3 i_B - e_1 i_B + e_3 i_C - e_2 i_C$

Collecting terms:

p=. $P_total = e_2(i_A - i_C) + e_1_(-i_A - i_B) + e_3(i_B + i_C)
...
h4(#chapter3-contradiction). 3.4 - Contradiction of Constraints

One might try to consider a circuit that is inherently ‘impossible’ from a circuits point-of-view.  For example consider a circuit composed of 3 voltage sources each of 5 volts, as connected in "Figure 3.6":#figure3-6.
