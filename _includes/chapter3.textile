...
p=. $P_{total} = e_2(i_A - i_C) + e_1_(-i_A - i_B) + e_3(i_B + i_C)
...
h4(#chapter3-contradiction). 3.4 - Conflicting of Constraints

One might try to consider a circuit that is inherently '_impossible_' from a circuits point-of-view.  For example consider a circuit composed of 3 voltage sources each of 5 volts, as connected in "Figure 3.6":#figure3-6.
