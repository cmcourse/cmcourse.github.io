...
p=(#figure10-9). !{width:70%}img/10/circuitsF10.9.jpg(Figure 10.9)!:img/10/circuitsF10.9.jpg
...
# The currents into the (+) and (-) input terminals are zero. [$i_(+)$ = 0 ...... and ...... $i_(-)$ = 0]
# The two voltages $V+$ and $V-$ are equal.  [$V+ = V-$]
$ The range of $V_{out}$ is less than $V_{CC}$ and greater than $-V_{EE}$: [$-V_{EE}$ < $V_{out}$ < $V_{CC}$]
...
p=(#figure10-10). !{width:70%}img/10/circuitsF10.10.jpg(Figure 10.10)!:img/10/circuitsF10.10.jpg
