...
h4(#chapter7-uniform-power). 7.3 - Example: Four Resistor Equal Heating
...
To determine the value for the power dissipated in terms of the voltage source $V_S$, we use the equivalent circuit of "Figure 7.6":#figure7-6, with resistor values given in terms of $R_1$.
 ...
 p=(#figure7-6). !{width:42%}img/7/circuitsF7.6.jpg(Figure 7.6)!:img/7/circuitsF7.6.jpg
...
Finally, to design specific values for the resistances to be used we need to select the desired power level and supply voltage.  If we use ¼ watt resistors, and if we are able to notice heating by touch at about ½ that rated power; then we should design for 1/8 watt dissipation _in each resistor_.
