...
** _(i) Parallel Connect Resistors_
...
Hence to get equal power dissipated by these 2 _parallel_ resistors we need $i_1 = i_2$.  Now for each resistor we can apply ohm's law, this leads to the obvious answer: when $R_1 = R_2$ there is equal power dissipated in both resistors.

** _(ii) Series Cnnected Resistors_
...
For this circuit the voltages and currents are depicted in "Figure 7.5":#figure7-5.  Note the two $R_2$ resistors are in series so they both have the same current $i_2$, and the two $R_1$ resistors are in parallel and have the same current $i_1$ because they have the smae resistnace value.

p=(#figure7-5). !{width:42%}img/7/circuitsF7.5a.jpg(Figure 7.5)!:img/7/circuitsF7.5a.jpg
