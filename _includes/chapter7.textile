...
where, $i_1$ and $i_2$ are the currents in resistors $R_1$ and $R_2$ respectively, and $v_1$ and $v_2$ are the voltages _across_ $R_1$ and $R_2$, respectively.  But here the two resistors are connected in _parallel_, to same node-pair, an equal voltage connection.  Hence $v_1 = v_2$.  Also they are in parallel with the voltage source $V_S$, so by substitution: $v_1 = v_2 = V_S$, and thus, equation [2].
...
p=(#figure7-3). !{width:70%}img/7/circuitsF7.3.jpg(Figure 7.3)!:img/7/circuitsF7.3.jpg
