...
As we have seen above, when the voltage ratio is exactly ½ then $R_S$ is the connected RL value.  On the other hand, if the voltage ratio is *greater than* 1/2, $R_S$ is smaller than $R_L$, whereas when the voltage ratio is *less than* 1/2, $R_S$ is larger than $R_L$.
