...
p=. $\frac{R_S}{R_L}$ = $(\frac{V_{out-open}{V_{out-Load}}-1)$

More generally we can make the normalized plot of RS/RL, versus the 2 tests voltage ratio, vLoad/vOpen as depicted in "Figure 7.12":#figure7-12.  Here the region where RS is within about a factor of 2 from the connected load resistance, $R_L$, is shown.

p=(#figure7-12). !{width:80%}img/7/circuitsF7.12.jpg(Figure 7.12)!:img/7/circuitsF7.12.jpg
