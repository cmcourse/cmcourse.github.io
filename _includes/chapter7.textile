...
p=. $R_S$ = $R_L$ when $(V_{out-Load}$ = ($\frac{1}{2}$) $V_{out-open}$-1)
...
More generally we can make the normalized plot of $R_S$ / $R_L$, versus the 2 tests voltage ratio, vLoad/vOpen as depicted in "Figure 7.12":#figure7-12.  Here the region where $R_S$ is within about a factor of 2 from the connected load resistance, $R_L$, is shown.
