...
We can therefore express this resisitor constitutive relation in terms of the element voltage by:
...
This commonly used form for the resistor element voltage-current relation is called _Ohm's Law_.
